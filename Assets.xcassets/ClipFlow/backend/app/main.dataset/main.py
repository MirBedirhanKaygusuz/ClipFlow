...
from app.api.routes import upload, process, download, styles, folders, music, thumbnails, validate, presets, waveform
...
app.include_router(waveform.router, prefix="/api/v1", tags=["waveform"])
